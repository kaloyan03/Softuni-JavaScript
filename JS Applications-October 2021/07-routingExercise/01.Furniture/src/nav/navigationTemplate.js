...
<a id="catalogLink" href="/dashboard" class="${ifDefined(navInfo['currentPage'].startsWith('/dashboard') ? 'active' : undefined)}">Dashboard</a>
            ...
            : html`<div id="guest">
                 <a id="loginLink" href="/login" class="${ifDefined(navInfo['currentPage'].startsWith('/logout') ? 'active' : undefined)}">Login</a>
                 <a id="registerLink" href="/register" class ="${ifDefined(navInfo['currentPage'].startsWith('/logout') ? 'active' : undefined)}">Register</a>
             </div>`}        
`